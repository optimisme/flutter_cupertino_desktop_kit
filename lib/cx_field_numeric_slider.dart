...
import 'cx_picker_slider.dart';

// Copyright © 2023 Albert Palacios. All Rights Reserved.
// Licensed under the BSD 3-clause license, see LICENSE file for details.

class CXFieldNumericSlider extends StatefulWidget {
  ...
  @override
  CXFieldNumericSliderState createState() => CXFieldNumericSliderState();
}

class CXFieldNumericSliderState extends State<CXFieldNumericSlider> {
  GlobalKey<CSPickerSliderState> keyPicker = GlobalKey();
  ...
  @override
  void didUpdateWidget(CXFieldNumericSlider oldWidget) {
