...
class CXAppSidebars extends StatefulWidget {
  ...
  @override
  CXAppSidebarsState createState() => CXAppSidebarsState();
}
...
/// and width.
class CXAppSidebarsState extends State<CXAppSidebars> {
  MouseCursor _cursor =
            ...
            AnimatedPositioned(
              ...
              child: Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: CXTheme.grey500.withOpacity(0.3),
                        spreadRadius: 0,
                        blurRadius: 2,
