...
import 'cx_button_disclosure.dart';

// Copyright © 2023 Albert Palacios. All Rights Reserved.
// Licensed under the BSD 3-clause license, see LICENSE file for details.

class CXUtilDisclosure extends StatefulWidget {
  final Widget title;
  final Widget child;
  final ValueChanged<bool>? onChanged;

  const CXUtilDisclosure({
    Key? key,
    required this.title,
    required this.child,
    this.onChanged,
  ...
  @override
  CXUtilDisclosureState createState() => CXUtilDisclosureState();
}

class CXUtilDisclosureState extends State<CXUtilDisclosure>
