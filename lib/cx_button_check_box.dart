...
class CXButtonCheckBox extends StatefulWidget {
  ...
  @override
  CXButtonCheckBoxState createState() => CXButtonCheckBoxState();
}
...
class CXButtonCheckBoxState extends State<CXButtonCheckBox> {
  @override
  Widget build(BuildContext context) {
    CXTheme themeManager = CXThemeNotifier.of(context)!.changeNotifier;
