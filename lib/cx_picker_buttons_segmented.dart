...
class CXPickerButtonsSegmented extends StatefulWidget {
  final List<Widget> options;
  final int defaultIndex;
  final Function(int)? onSelect;
  final bool isAccent;

  const CXPickerButtonsSegmented({
    Key? key,
  ...
  @override
  CXPickerButtonsSegmentedState createState() =>
      CXPickerButtonsSegmentedState();
}

/// Class `DSKButtonsSegmentedState` - The state for `DSKButtonsSegmented`.
///
/// Manages the state and rendering of the segmented control.
class CXPickerButtonsSegmentedState extends State<CXPickerButtonsSegmented> {
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: widget.isAccent
                      ...
                      : [
                          BoxShadow(
                            color: CXTheme.black.withOpacity(0.15),
                            spreadRadius: 0,
                            blurRadius: 1,
