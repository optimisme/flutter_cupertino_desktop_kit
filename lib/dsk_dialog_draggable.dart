...
class DSKDialogDraggable extends StatefulWidget {
  ...
  @override
  DSKDialogDraggableState createState() => DSKDialogDraggableState();
}

class DSKDialogDraggableState extends State<DSKDialogDraggable>
        ...
        : Stack(children: [
            Positioned(
                ...
                child: GestureDetector(
                    onTapDown: (details) {
                      DSKDialogsManager.moveDraggableToTop(
