...
class CSPickerSlider extends StatefulWidget {
  final double defaultValue;
  final double size;
  final bool enabled;
  final Function(double)? onChanged;

  const CSPickerSlider({
    Key? key,
    this.defaultValue = 0,
    this.enabled = true,
    this.size = 16,
  ...
  @override
  CSPickerSliderState createState() => CSPickerSliderState();
}

class CSPickerSliderState extends State<CSPickerSlider> {
