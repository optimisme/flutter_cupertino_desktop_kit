...
class CDKPickerButtonsBar extends StatefulWidget {
  ...
  @override
  State<CDKPickerButtonsBar> createState() => _CDKPickerButtonsBarState();
}

class _CDKPickerButtonsBarState extends State<CDKPickerButtonsBar> {
  ...
  void initState() {
    ...
    if (widget.selectedStates.length != widget.options.length) {
      throw Exception(
          "_CDKPickerButtonsBarState initState: selectedStates and options must have the same length");
    }
  }
