...
class CDKProgressCircular extends StatefulWidget {
  ...
  @override
  State<CDKProgressCircular> createState() => _CDKProgressCircularState();
}

class _CDKProgressCircularState extends State<CDKProgressCircular>
  ...
  void initState() {
    ...
    if (widget.value < 0 || widget.value > 1) {
      throw Exception(
          "_CDKProgressCircularState initState: value must be between 0 and 1");
    }
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return CustomPaint(
          painter: _CDKProgressCircularPainter(
...
class _CDKProgressCircularPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(covariant _CDKProgressCircularPainter oldDelegate) {
