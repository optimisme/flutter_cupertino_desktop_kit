...
class CDKPickerColorHSV extends StatefulWidget {
  ...
  @override
  State<CDKPickerColorHSV> createState() => _CDKPickerColorHSVState();
}

class _CDKPickerColorHSVState extends State<CDKPickerColorHSV> {
  ...
  Widget build(BuildContext context) {
    ...
    _gradientAlphaColors[1] = Color(widget.value.toARGB32() | 0xFF000000);
