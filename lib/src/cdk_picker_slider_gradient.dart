...
class CDKPickerSliderGradient extends StatefulWidget {
  ...
  final double value;
  final bool enabled;
  final void Function(double, Color)? onChanged;
  ...
  @override
  State<CDKPickerSliderGradient> createState() =>
      _CDKPickerSliderGradientState();
...
class _CDKPickerSliderGradientState extends State<CDKPickerSliderGradient> {
  @override
  void initState() {
    super.initState();
    if (widget.value < 0 || widget.value > 1) {
      throw Exception(
          "_CDKPickerSliderGradientState initState: value must be between 0 and 1");
    }
  }
