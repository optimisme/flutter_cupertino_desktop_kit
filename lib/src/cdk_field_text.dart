...
class CDKFieldText extends StatefulWidget {
  ...
  @override
  State<CDKFieldText> createState() => _CDKFieldTextState();
}

class _CDKFieldTextState extends State<CDKFieldText> {
  ...
  @override
  void didUpdateWidget(covariant CDKFieldText oldWidget) {
