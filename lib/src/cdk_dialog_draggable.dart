...
class CDKDialogDraggable extends StatefulWidget {
  ...
  @override
  State<CDKDialogDraggable> createState() => _CDKDialogDraggableState();
}

class _CDKDialogDraggableState extends State<CDKDialogDraggable>
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (mounted) {
        setState(() {
          ...
          final anchorCenterX =
              anchorPosition.dx + anchorRenderBox.size.width / 2;
          final anchorCenterY =
              anchorPosition.dy + anchorRenderBox.size.height / 2;
