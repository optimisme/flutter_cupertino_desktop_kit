...
class CDKProgressBar extends StatefulWidget {
  ...
  @override
  State<CDKProgressBar> createState() => _CDKProgressBarState();
}

class _CDKProgressBarState extends State<CDKProgressBar>
  ...
  void initState() {
    ...
    if (widget.value < 0 || widget.value > 1) {
      throw Exception(
          "_CDKProgressBarState initState: value must be between 0 and 1");
    }
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return CustomPaint(
          painter: _CDKProgressBarPainter(
...
class _CDKProgressBarPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(covariant _CDKProgressBarPainter oldDelegate) {
