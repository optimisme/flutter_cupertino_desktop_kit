...
class CXDialogDraggable extends StatefulWidget {
  ...
  @override
  CXDialogDraggableState createState() => CXDialogDraggableState();
}

class CXDialogDraggableState extends State<CXDialogDraggable>
        ...
        : Stack(children: [
            Positioned(
                ...
                child: GestureDetector(
                    onTapDown: (details) {
                      CXDialogsManager.moveDraggableToTop(
