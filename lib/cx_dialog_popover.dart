...
import 'cx_dialog_outer_shadow_painter.dart';
import 'cx_dialog_popover_clipper.dart';
import 'cx_theme.dart';

// Copyright © 2023 Albert Palacios. All Rights Reserved.
// Licensed under the BSD 3-clause license, see LICENSE file for details.

enum CXDialogPopoverType { down, center, side }
// TODO 'side' type

class CXDialogPopover extends StatefulWidget {
  final GlobalKey anchorKey;
  final CXDialogPopoverType type;
  final bool isAnimated;
  final bool isTranslucent;
  final Function? onHide;
  final Widget child;

  const CXDialogPopover({
    Key? key,
    required this.anchorKey,
    this.type = CXDialogPopoverType.center,
  ...
  @override
  CXDialogPopoverState createState() => CXDialogPopoverState();
}

class CXDialogPopoverState extends State<CXDialogPopover>
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted && childKey.currentContext != null) {
        setState(() {
          ...
          if (widget.type == CXDialogPopoverType.center) {
            leftPosition =
          ...
          pathContour =
              CXDialogOuterShadowPainter.createContourPath(rectContour);
          final rectClip = Rect.fromLTWH(0, 0, width!, height!);
          pathClip = CXDialogOuterShadowPainter.createContourPath(rectClip);
  ...
  Widget build(BuildContext context) {
    ...
    Widget dialogWithDecorations = !isSizeDetermined
        ...
        : Stack(
            children: [
              CustomPaint(
                painter: CXDialogOuterShadowPainter(
              ...
              Positioned(
                  ...
                  child: !widget.isTranslucent
                      ...
                      : ClipPath(
                          clipper:
                              CXPopoverClipper(pathClip), // Aplica el clip aquí
