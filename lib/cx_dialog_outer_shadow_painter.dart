...
class CXDialogOuterShadowPainter extends CustomPainter {
  final Color colorBackground;
  final Path pathContour;
  final bool isLightTheme;

  CXDialogOuterShadowPainter(
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final paintLine = Paint()
      ..strokeWidth = 0.5
      ..color = isLightTheme ? CXTheme.grey200 : CXTheme.grey500
  ...
  void _drawShadow(Canvas canvas, Path path, Size size) {
    ...
    Color shadowColor =
        isLightTheme ? CXTheme.black.withOpacity(0.5) : CXTheme.black;
  ...
  @override
  bool shouldRepaint(covariant CXDialogOuterShadowPainter oldDelegate) {
