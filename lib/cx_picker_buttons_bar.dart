...
class CXPickerButtonsBar extends StatefulWidget {
  ...
  @override
  CXPickerButtonsBarState createState() => CXPickerButtonsBarState();
}

/// Class `DSKButtonsBarState` - The state for `DSKButtonsBar`.
///
/// Manages the state and rendering of the buttons bar.
class CXPickerButtonsBarState extends State<CXPickerButtonsBar> {
  ...
  Widget fixWidgetStyle(Widget widget, int index, CXTheme theme) {
              ...
              gradient: LinearGradient(
                ...
                colors: _selectedStates[index]['value']
                    ? theme.isAppFocused
                        ...
                        : [CXTheme.grey200, CXTheme.grey300]
