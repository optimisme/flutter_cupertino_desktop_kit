...
class CXDialogPopoverArrowed extends StatefulWidget {
  ...
  @override
  CXDialogPopoverArrowedState createState() => CXDialogPopoverArrowedState();
}

class CXDialogPopoverArrowedState extends State<CXDialogPopoverArrowed>
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted && childKey.currentContext != null) {
        setState(() {
          ...
          pathContour = CXDialogOuterShadowPainter.createContourPathArrowed(
              rectContour, arrowDiff, arrowAtBottom);
          final rectClip = Rect.fromLTWH(0, 0, width!,
              height! - 8); // -8 To give space for the shadow if at top
          pathClip = CXDialogOuterShadowPainter.createContourPathArrowed(
