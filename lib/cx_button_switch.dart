...
class CXButtonSwitch extends StatefulWidget {
  final bool value;
  final double size;
  final ValueChanged<bool>? onChanged;

  const CXButtonSwitch({
    Key? key,
    required this.value,
    this.onChanged,
    this.size = 24.0,
