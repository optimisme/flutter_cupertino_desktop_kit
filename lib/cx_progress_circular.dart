...
class CXProgressCircular extends StatefulWidget {
  final double progress;
  final bool isIndeterminate;
  final bool isRunning;

  const CXProgressCircular({
    Key? key,
    this.progress = 0.0,
  ...
  @override
  CXProgressCircularState createState() => CXProgressCircularState();
}

class CXProgressCircularState extends State<CXProgressCircular>
  ...
  @override
  void didUpdateWidget(CXProgressCircular oldWidget) {
    ...
    if (isIndeterminate) {
      ...
      for (int i = 0; i < 8; i++) {
        ...
        if (isIndeterminateAnimating) {
          ...
          if (isLightTheme) {
            lineColor = CXTheme.grey700.withAlpha(alpha);
          } else {
            lineColor = CXTheme.grey.withAlpha(alpha);
          }
        }
      ...
      Paint progressPaint = Paint()
        ..color = hasAppFocus ? colorAccent : CXTheme.grey
        ..style = PaintingStyle.fill;
