...
class CXPicker360 extends StatefulWidget {
  ...
  @override
  CXPicker360State createState() => CXPicker360State();
}

class CXPicker360State extends State<CXPicker360> {
    ...
    return GestureDetector(
      ...
      child: CustomPaint(
        painter: DSKPicker360Painter(
            ...
            _currentAngle,
            widget.enabled ? theme.colorText : CXTheme.grey,
            theme.isLight ? CXTheme.grey100 : CXTheme.grey),
